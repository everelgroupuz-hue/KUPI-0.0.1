...
export const Orders = () => {
  ...
  const processingOrders = filteredOrders.filter(o => ['processing', 'assembling', 'assembled', 'shipping', 'paid', 'shipped'].includes(o.status ?? ''));
  const historyOrders = filteredOrders.filter(o => ['delivered', 'cancelled', 'returned', 'return_requested'].includes(o.status ?? ''));
            ...
            <section>
              <div className="flex items-center gap-2 mb-3">
                ...
                <h2 className="text-sm font-bold text-surface-900 dark:text-white">
                  {language === 'ru' ? 'Новые заказы' : 'Yangi buyurtmalar'}
                </h2>
          ...
          {processingOrders.length > 0 && (
            <section>
              <div className="flex items-center gap-2 mb-3">
                ...
                <h2 className="text-sm font-bold text-surface-900 dark:text-white">
                  {language === 'ru' ? 'В обработке' : 'Qayta ishlanmoqda'}
                </h2>
          ...
          {historyOrders.length > 0 && (
            <section>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs bg-surface-100 dark:bg-surface-700 text-surface-500 dark:text-surface-400 font-semibold px-2 py-0.5 rounded-full">
